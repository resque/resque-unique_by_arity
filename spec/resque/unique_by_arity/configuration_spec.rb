  ...
  context "logging" do
    ...
    describe "#initialize" do
      ...
      context "arity_for_uniqueness option" do
        ...
        it "sets arity_for_uniqueness" do
          expect(subject).to eq(arity_for_uniqueness)
        end
      end
      ...
      context "arity_for_uniqueness_at_runtime option" do
        ...
        it "sets arity_for_uniqueness_at_runtime" do
          expect(subject).to eq(arity_for_uniqueness_at_runtime)
        end
      end
      ...
      context "arity_for_uniqueness_in_queue option" do
        ...
        it "sets arity_for_uniqueness_in_queue" do
          expect(subject).to eq(arity_for_uniqueness_in_queue)
        end
      end
      ...
      context "arity_for_uniqueness_across_queues option" do
        ...
        it "sets arity_for_uniqueness_across_queues" do
          expect(subject).to eq(arity_for_uniqueness_across_queues)
        end
      end
      ...
      context "arity_validation option" do
        ...
        it "sets arity_validation" do
          expect(subject).to eq(arity_validation)
        end
      end
      ...
      context "lock_after_execution_period option" do
        ...
        it "sets lock_after_execution_period" do
          expect(subject).to eq(lock_after_execution_period)
        end
      end
      ...
      context "runtime_lock_timeout option" do
        ...
        it "sets runtime_lock_timeout" do
          expect(subject).to eq(runtime_lock_timeout)
        end
      end
      ...
      context "runtime_requeue_interval option" do
        ...
        it "sets runtime_requeue_interval" do
          expect(subject).to eq(runtime_requeue_interval)
        end
      end
      ...
      context "unique_at_runtime option" do
        ...
        it "sets unique_at_runtime" do
          expect(subject).to eq(unique_at_runtime)
        end
      end
      ...
      context "unique_in_queue option" do
        ...
        it "sets unique_in_queue" do
          expect(subject).to eq(unique_in_queue)
        end
      end
      ...
      context "unique_in_queue_key_base option" do
        ...
        it "sets unique_in_queue_key_base" do
          expect(subject).to eq(unique_in_queue_key_base)
        end
      end
      ...
      context "unique_across_queues option" do
        ...
        it "sets unique_across_queues" do
          expect(subject).to eq(unique_across_queues)
        end
      end
    ...
    describe "#base_klass_name" do
      ...
      it "sets base_klass_name" do
        expect(subject).to eq(base_klass_name)
      end
    end
  end
end
