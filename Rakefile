...
# resque-unique_by_arity Rakefile v7.1.0 - 2026-08-01
...
# rake install                                # Build and install resque-unique_by_arity-1.0.0.gem in...
# rake install:local                          # Build and install resque-unique_by_arity-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template resque-unique_by_arity against itse...
